...
To ensure consistent predictions across CLI, web dashboard, and API pipelines, all models generated by `train.py`, `train_v2.py`, and `train_v3.py` adhere to a unified preprocessing contract:
